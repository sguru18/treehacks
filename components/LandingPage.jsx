    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-4xl mx-auto px-6 pt-32 pb-20 text-center">
        ...
        >
          ...
          docs and spreadsheets. Daisy closes the gap — from customer feedback to
          roadmaps, sprint planning, and shipped features, automatically.
        </motion.p>
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            ...
            <motion.h2 variants={stepFade} className="text-3xl font-semibold text-gray-900 mb-3">
              From raw feedback to your next sprint
            </motion.h2>
          ...
          >
            {[
              { n: '01', title: 'Connect', desc: 'Syncs with Salesforce, Zendesk, Intercom, Slack, Gong, and more — pulls customer data automatically.', icon: 'M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m9.86-2.54a4.5 4.5 0 00-6.364-6.364L4.5 8.25a4.5 4.5 0 006.364 6.364l4.5-4.5z' },
              { n: '02', title: 'Analyze', desc: 'AI identifies pain points, feature requests, praise, and confusion patterns across all sources.', icon: 'M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.383a14.406 14.406 0 01-3 0M14.25 18v-.192c0-.983.658-1.823 1.508-2.316a7.5 7.5 0 10-7.517 0c.85.493 1.509 1.333 1.509 2.316V18' },
      ...
      <section id="solutions" className="py-20">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            {[
              { role: 'Founders', desc: 'Stop spending weekends in spreadsheets. Connect your tools and get a clear roadmap in minutes, not weeks.', highlight: 'Save 10+ hours per sprint' },
              { role: 'Product Managers', desc: 'Auto-generated roadmaps, story points, and sprint plans — all backed by real customer evidence you can cite in your PRD.', highlight: 'AI-powered roadmaps' },
              { role: 'Engineering Leads', desc: 'Get pointed, scoped tickets with acceptance criteria and effort estimates your team (or AI agent) can start building immediately.', highlight: 'Sprint-ready dev tasks' },
            ].map((item) => (
      ...
      <section className="bg-gray-50 py-20">
        <div className="max-w-5xl mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-14"
          >
            <motion.p variants={stepFade} className="text-[12px] font-semibold text-brand-600 uppercase tracking-wider mb-2">Features</motion.p>
            <motion.h2 variants={stepFade} className="text-3xl font-semibold text-gray-900 mb-3">
              Everything your product team needs
            </motion.h2>
            <motion.p variants={stepFade} className="text-[15px] text-gray-500 max-w-lg mx-auto leading-relaxed">
              Roadmapping, sprint planning, story pointing — all powered by real customer data.
            </motion.p>
          </motion.div>
          ...
          >
            {[
              { title: 'Product Roadmap', desc: 'Auto-generate a prioritized roadmap from customer signals. Drag-and-drop to adjust, share with stakeholders in one click.', icon: 'M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z' },
              { title: 'Story Pointing', desc: 'AI estimates complexity based on codebase context, past velocity, and feature scope. Calibrated to your team\'s history.', icon: 'M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z' },
              { title: 'Sprint Planning', desc: 'Break features into scoped sprints with effort estimates. Balances new features, tech debt, and bug fixes automatically.', icon: 'M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5' },
              { title: 'Backlog Management', desc: 'A living backlog that re-prioritizes itself as new feedback flows in. No more stale tickets sitting for months.', icon: 'M8.25 6.75h12M8.25 12h12m-12 5.25h12M3.75 6.75h.007v.008H3.75V6.75zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zM3.75 12h.007v.008H3.75V12zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm-.375 5.25h.007v.008H3.75v-.008zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z' },
              { title: 'Agile Workflows', desc: 'Kanban boards, sprint retros, and velocity tracking built in. Works with Scrum, Kanban, or your own hybrid process.', icon: 'M9 4.5v15m6-15v15m-10.875 0h15.75c.621 0 1.125-.504 1.125-1.125V5.625c0-.621-.504-1.125-1.125-1.125H4.125C3.504 4.5 3 5.004 3 5.625v12.75c0 .621.504 1.125 1.125 1.125z' },
              { title: 'Spec Generation', desc: 'One-click PRDs and technical specs with acceptance criteria, edge cases, and agent-ready dev prompts.', icon: 'M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z' },
            ].map((feature) => (
              <motion.div key={feature.title} variants={stepFade} className="bg-white border border-gray-200 rounded-xl p-5 hover:shadow-sm transition-shadow">
                <div className="w-9 h-9 rounded-lg bg-brand-50 border border-brand-100 flex items-center justify-center text-brand-700 mb-3">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d={feature.icon} /></svg>
                </div>
      ...
      <section id="pricing" className="py-20">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            {[
              { plan: 'Starter', price: 'Free', period: '', desc: 'For founders and small teams getting started.', features: ['5 integrations', 'Insight extraction', 'Basic roadmap', 'Community support'], cta: 'Get Started', primary: false },
              { plan: 'Pro', price: '$49', period: '/mo', desc: 'For product teams shipping every week.', features: ['Unlimited integrations', 'Roadmap & sprint planning', 'Story pointing & estimation', 'Spec generation', 'Agent-ready prompts'], cta: 'Start Free Trial', primary: true },
              { plan: 'Enterprise', price: 'Custom', period: '', desc: 'For organizations with advanced needs.', features: ['Everything in Pro', 'SSO & SAML', 'Jira & Linear sync', 'Dedicated CSM', 'SLA guarantee'], cta: 'Contact Sales', primary: false },
            ].map((plan) => (
              <motion.div
                key={plan.plan}
                variants={stepFade}
      ...
      <section id="docs" className="bg-gray-50 py-20">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            {[
              { tag: 'Guide', title: 'Getting started with Daisy', desc: 'Connect your first integration and generate insights in under 5 minutes.' },
