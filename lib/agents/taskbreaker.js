...
4. storyPoints: Fibonacci story points (1, 2, 3, 5, 8, 13) reflecting relative complexity
5. estimatedEffort: One of "xs" (< 30min), "s" (30min-2hr), "m" (2-4hr), "l" (4-8hr), "xl" (1-2 days)
6. acceptanceCriteria: Array of specific, testable criteria
7. dependsOn: Array of task indices (0-based) this task depends on. Empty array if no dependencies.
8. sprintSuggestion: Which sprint this belongs in (1, 2, or 3) based on dependencies and priority
9. agentPrompt: A DETAILED prompt (100-300 words) ready to paste into an AI coding agent. Include:
   - What to build
