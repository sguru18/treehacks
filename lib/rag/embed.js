 ...
 * Dimension defaults to 1536; set RAG_EMBED_DIMENSION=1024 to match a 1024-dim Pinecone index.
 *
 * @module lib/rag/embed
 */

const EMBEDDING_MODEL = 'text-embedding-3-small';
const DIMENSION = parseInt(process.env.RAG_EMBED_DIMENSION || '1536', 10) || 1536;
